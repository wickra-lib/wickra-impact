...
repository pins `wickra-impact-core` from three manifests rather than one, ships the
...
TOUCHPOINTS: list[tuple[str, str, str, int]] = [
    ...
    ("Cargo.toml", "workspace dependency pin", r'wickra-impact-core = \{ version = "@V@", path = ', 1),
    # Two manifests pin wickra-impact-core by path *and* version instead of through
    ...
    (
        ...
        "wickra-impact-core pin",
        r'path = "\.\./\.\./crates/impact-core", version = "@V@"',
        1,
    ),
    (
        "crates/impact-bench/Cargo.toml",
        "wickra-impact-core pin",
        r'path = "\.\./impact-core", version = "@V@"',
        1,
    ),
    ...
    (
        "bindings/csharp/WickraImpact/WickraImpact.csproj",
        "NuGet version",
        r"<Version>@V@</Version>",
        1,
    ),
    ...
    ("examples/README.md", "sample output", r"wickra-impact @V@", 1),
    ...
    (
        ...
        r'"name": "wickra-impact",\s+"version": "@V@"',
        2,
    ),
]
